            ...
            if FLAGS.process_seq:
                ...
                for fr in ['ED', 'ES']:
                    ...
                    if FLAGS.save_seg:
                        ...
                        os.system('ln -sf {0} {1}'.format(image_name, dest_data_dir))
                        label_name = '{0}/{1}_{2}.nii.gz'.format(data_dir, 'label', fr)
                        label_name = re.sub('_Norm', '', label_name)
                        os.system('ln -sf {0} {1}'.format(label_name, dest_data_dir))
